...
class WSJMixDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        if self.ref_is_reverb:
            ref1_path = data["speech_reverberant_clean"][0]
            ref2_path = data["speech_reverberant_clean"][1]
        else:
            ref1_path = data["speech_anechoic_clean"][0]
            ref2_path = data["speech_anechoic_clean"][1]
